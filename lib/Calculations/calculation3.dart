...
class calculation3 extends StatefulWidget {
  const calculation3({Key? key}) : super(key: key);

  @override
  State<calculation3> createState() => _calculation3State();
}

class _calculation3State extends State<calculation3> {
