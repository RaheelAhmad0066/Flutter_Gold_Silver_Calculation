...
class calculation4 extends StatefulWidget {
  const calculation4({Key? key}) : super(key: key);

  @override
  State<calculation4> createState() => _calculation4State();
}

class _calculation4State extends State<calculation4> {
